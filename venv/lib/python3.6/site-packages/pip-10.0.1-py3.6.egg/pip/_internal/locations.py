...
if running_under_virtualenv():
    src_prefix = os.path.join(sys.prefix, 'windows_src')
else:
    # FIXME: keep windows_src in cwd for now (it is not a temporary folder)
    try:
        src_prefix = os.path.join(os.getcwd(), 'windows_src')
    except OSError:
